...
El Manual Maestro no inventa reglas para rellenar huecos. Cada bloque se incorpora después de contrastar el canon mecánico 1.0, el contenido implementado y el material histórico que siga expresamente vigente. Las contradicciones se resuelven antes de declarar una sección definitiva. Foundry implementa el manual; no crea canon por sí solo.
...
4. Atributos, Habilidades y Especializaciones
5. Desarrollo, niveles y PD
6. Rasgos y PR
7. Turno, acciones y movimiento
8. Combate, armas, armaduras y escudos
9. Escala, maniobras y estados
10. Vida, daño, Heridas Graves, Trauma y recuperación
11. Magia: Fuentes, Disciplinas, Maná, Sobrecarga y Sostenimiento
12. Grimorio completo
13. Técnicas
...
19. Equipo, economía y disponibilidad
20. Razas, orígenes y profesiones
21. Vehículos, monturas y autómatas
22. PNJ, criaturas y dirección de juego
23. Mundo, pueblos, mitología y Panteón Primordial
...
## 3. Personaje y creación

Los siete Atributos son **FUE, AGI, VIG, INT, PER, VOL y PRE**. Su escala de referencia es: 0 deficiente, 1 adulto normal, 2 notable, 3 excepcional, 4 élite, 5 límite natural y 6+ sobrenatural.

En creación todos comienzan en 1 y se distribuyen 6 aumentos, con máximo inicial normal 3. El personaje dispone de **25 PD**, **3 PR** separados y **100 C**. Durante la creación puede tener como máximo una Habilidad en Experto.

Las 26 Habilidades son Atletismo, Acrobacia, Sigilo, Supervivencia, Naturaleza, Investigación, Persuasión, Engaño, Intimidación, Empatía, Historia, Religión, Medicina, Arcana, Artesanía, Ingeniería, Alquimia, Latrocinio, Armas Ligeras, Armas Marciales, Armas Pesadas, Armas a Distancia, Canalización, Ritualismo, Manejo y Pilotaje.

Los rangos son Sin Entrenar +0, Aprendiz +1, Entrenado +2, Experto +4, Maestro +6 y Gran Maestro +8. Sus costes acumulados son 0/1/3/7/13/21 PD.

Los valores derivados principales son: **Vida = 10 + 2xVIG**, **Maná = 6 + 3xVOL**, **Defensa = 11 + AGI + Bono Defensivo + equipo/modificadores**, **Defensa Corporal = 11 + VIG**, **Defensa Mental = 11 + VOL** y **Defensa de Maniobra = 11 + AGI + Bono Defensivo**. La Iniciativa es 2d10 + PER + modificadores.
...
**Chispa — Truco, 0-1 Maná.** Manifestación energética trivial compatible con la Fuente; no sustituye un hechizo ofensivo.

**Pulso — Truco, 1 Maná.** Impulso energético menor de utilidad contextual.

**Impulso — Menor, 2 Maná.** Fuerza breve y limitada sobre un objetivo compatible.

**Proyectil Ígneo — Básico, 3 Maná.** Ataque a distancia Media contra Defensa. Daño 5, Pen 1.

**Descarga — Básico, 4 Maná.** Ataque energético a distancia Cerca. Daño 5, Pen 1.

**Onda de Choque — Básico, 4 Maná.** Área frontal corta; Daño 4 y empuje 1 cuando corresponda. Una tirada se compara con cada Defensa.

**Barrera Cinética — Básico, 3 Maná.** Reacción; +2 Defensa contra el ataque declarado.

**Lanza — Avanzado, 6 Maná.** Ataque energético potente. Daño 8, Pen 2.

### Alteración

**Molde — Truco.** Alteración trivial de forma/material compatible sin crear materia valiosa ni efectos estructurales mayores.

**Ajuste — Truco, 1 Maná.** Modificación menor y temporal compatible.

**Paso Ligero — Menor, 2 Maná.** Facilita desplazamiento compatible sin anular todos los riesgos del terreno.

**Adaptación — Básico, 3 Maná.** Adapta temporalmente al objetivo a una condición ambiental definida y compatible.

**Potencia Sobrenatural — Básico, 4 Maná, Sostenido.** Permite interactuar físicamente como una categoría de Escala mayor; no aumenta FUE, tamaño, alcance, Defensa, armas ni resistencias.

**Alterar Forma — Básico, 4 Maná.** Transformación limitada según una forma compatible; no concede capacidades no definidas por el efecto.

**Piel Alterada — Básico, 4 Maná, Sostenido.** Protección 2 contra una categoría coherente; no se acumula con armadura equivalente.

**Forma Adaptativa — Avanzado, 6 Maná.** Transformación funcional superior dentro de límites definidos por la forma y la Fuente.

### Restauración

**Alivio — Truco.** Reduce molestias menores compatibles; no cura Trauma ni Heridas Graves.

**Diagnóstico — Truco, 1 Maná.** Revela información médica/mágica accesible sobre una condición compatible; información no equivale automáticamente a interpretación experta.

**Estabilización — Menor, 2 Maná.** Estabiliza una condición o lesión compatible; no restaura por sí sola una Herida Grave.

**Cierre Restaurador — Básico, 3 Maná.** Requiere Medicina. Recupera 4 Vida y detiene Sangrado ordinario compatible.

**Purificación — Básico, 4 Maná.** Trata una toxina, contaminación o afección compatible según su potencia; no es una limpieza universal.

**Regeneración — Avanzado, 6 Maná.** Requiere Medicina; puede reparar una Herida Grave orgánica compatible.

**Restauración Profunda — Avanzado, 7 Maná.** Recuperación mayor de daño compatible sin equivaler a resurrección.

**Reconstrucción — Maestro, 10 Maná.** Requiere Medicina; reconstrucción extraordinaria de tejido/estructura compatible. No resucita muertos.

### Percepción

**Realce — Truco.** Mejora menor de una percepción existente; no concede omnisciencia.

**Marca — Truco, 1 Maná.** Señal perceptiva/mágica limitada para identificación posterior compatible.

**Visión Arcana — Menor, 2 Maná.** PER + Canalización cuando exista incertidumbre, DF de referencia 10; permite percibir fenómenos arcanos compatibles durante una Escena.

**Eco — Básico, 3 Maná.** Obtiene una impresión perceptiva limitada de un fenómeno o lugar compatible.

**Vínculo de Rastreo — Básico, 4 Maná.** PER; DF de referencia 14. Produce información aproximada de rastreo, no coordenadas GPS.

**Lectura de Huella — Avanzado, 5 Maná.** Examina rastros mágicos/perceptivos compatibles y permite inferencias limitadas según calidad de la huella.

**Visión Remota — Avanzado, 7 Maná.** PER; DF de referencia 18; requiere lugar conocido o Ancla. Percibe remotamente dentro de los límites del efecto, sin omnisciencia.

### Influencia

**Matiz — Truco.** Modificación emocional/social mínima que no sustituye Persuasión ni control mental.

**Susurro — Truco, 1 Maná.** Comunicación discreta con un receptor compatible y dispuesto según el efecto.

**Impulso Emocional — Menor, 2 Maná.** Favorece una emoción plausible; no impone conducta imposible.

**Calma — Básico, 3 Maná.** Se enfrenta a Defensa Mental cuando el objetivo resiste; reduce agitación compatible sin borrar voluntad o memoria.

**Silencio Mental — Básico, 3 Maná.** Reduce o bloquea una interferencia mental compatible dentro de sus límites.

**Sugestión — Avanzado, 5 Maná.** PRE + Canalización contra Defensa Mental. Implanta una instrucción plausible y limitada. No fuerza suicidio, traición fundamental automática ni Dominación completa.

El catálogo inicial no incluye Dominación directa. Un objetivo que haya resistido el mismo efecto mental sostenido/instancia no vuelve a ser susceptible durante la Escena sin un cambio significativo, salvo regla expresa.

### Conjuración

**Señal — Truco.** Manifestación o llamada conjurativa mínima.

**Mano — Truco, 1 Maná.** Manipulación menor a distancia dentro de límites de fuerza y precisión definidos por la ficción.

**Ancla — Menor, 2 Maná.** Establece una referencia conjurativa compatible para efectos posteriores.

**Llamada Menor — Básico, 4 Maná.** INT; DF de referencia 14. Convoca una entidad menor compatible. Invocar no equivale a controlar ni garantiza obediencia.

**Paso Breve — Básico, 4 Maná.** INT; DF de referencia 12 cuando se requiera prueba. Teletransporta al propio lanzador hasta 3 espacios a un destino visible, válido y desocupado.

**Trasposición — Avanzado, 6 Maná.** INT; DF de referencia 14; alcance hasta 8 espacios según condiciones del efecto.

**Umbral — Avanzado, 7 Maná.** INT; DF de referencia 18. Abre una transición espacial limitada compatible.
