export const STARTER_CONTENT = {
 weapon:[
  ...
  {name:"Espada corta",system:{skill:"lightWeapons",attackAttribute:"agi",damageAttribute:"fue",damage:4,penetration:0,strengthMin:1,price:12,properties:"Ligera"}},
  {name:"Sable",system:{skill:"lightWeapons",attackAttribute:"agi",damageAttribute:"fue",damage:5,penetration:0,strengthMin:1,price:18,properties:"Ágil"}},
  {name:"Espada larga",system:{skill:"martialWeapons",attackAttribute:"fue",damageAttribute:"fue",damage:5,penetration:0,strengthMin:2,price:20,properties:"Versátil"}},
  {name:"Hacha",system:{skill:"martialWeapons",attackAttribute:"fue",damageAttribute:"fue",damage:6,penetration:1,strengthMin:2,price:18,properties:"Impactante"}},
  {name:"Maza",system:{skill:"martialWeapons",attackAttribute:"fue",damageAttribute:"fue",damage:6,penetration:1,strengthMin:2,price:16,properties:"Impactante"}},
  ...
  {name:"Lanza",system:{skill:"martialWeapons",attackAttribute:"fue",damageAttribute:"fue",damage:5,penetration:1,strengthMin:1,price:12,properties:"Alcance, 2 manos"}},
  {name:"Alabarda",system:{skill:"heavyWeapons",attackAttribute:"fue",damageAttribute:"fue",damage:7,penetration:2,strengthMin:2,price:30,properties:"Alcance, Pesada, 2 manos"}},
  {name:"Mandoble",system:{skill:"heavyWeapons",attackAttribute:"fue",damageAttribute:"fue",damage:7,penetration:1,strengthMin:3,price:32,properties:"Pesada, 2 manos"}},
  {name:"Gran hacha",system:{skill:"heavyWeapons",attackAttribute:"fue",damageAttribute:"fue",damage:8,penetration:1,strengthMin:3,price:34,properties:"Pesada, 2 manos"}},
  {name:"Gran martillo",system:{skill:"heavyWeapons",attackAttribute:"fue",damageAttribute:"fue",damage:8,penetration:3,strengthMin:3,price:40,properties:"Pesada, 2 manos"}},
  ...
  {name:"Arco largo",system:{skill:"rangedWeapons",attackAttribute:"agi",damageAttribute:"fue",damage:5,penetration:1,power:3,rangeOptimal:30,price:25,properties:"Potencia 3, 2 manos"}},
  {name:"Ballesta",system:{skill:"rangedWeapons",attackAttribute:"per",damage:6,penetration:2,reload:1,rangeOptimal:25,price:22,properties:"Recarga 1"}},
  {name:"Ballesta pesada",system:{skill:"rangedWeapons",attackAttribute:"per",damage:8,penetration:3,reload:2,rangeOptimal:35,price:35,properties:"Recarga 2, 2 manos"}},
  {name:"Pistola temprana",system:{skill:"rangedWeapons",attackAttribute:"per",damage:7,penetration:2,reload:2,rangeOptimal:15,price:30,properties:"Recarga 2"}},
  {name:"Rifle temprano",system:{skill:"rangedWeapons",attackAttribute:"per",damage:8,penetration:3,reload:2,rangeOptimal:40,price:45,properties:"Recarga 2, 2 manos"}},
